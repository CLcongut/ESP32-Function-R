...
// #define wifi_SSID "Xiaomi 14"       // WIFI名字，不可中文
// #define wifi_PSWD "0xffffff" // WIFI密码，不可中文，最好 8 位
...
WiFiUDP udp;
int cnt = 0;
// IPAddress remote_IP(192, 168, 67, 116);
...
void setup()
{
  ...
  // memset(testS, 255, ARLEN);
  // String str_cnt = testS;
}
